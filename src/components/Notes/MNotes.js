...
import save from "../../Assets/save_enabled.png";
...
function MNotes() {
 ...
 <div style={{color:"white", margin:8 , fontSize:35}} onClick={goBack}>
<span> &larr;</span>
      ...
      <div className="m_notes_input">
        ...
        <button
          ...
          <img src={text.trim() ? save : enter} alt="save_notes" />
        </button>
      </div>
    </div>
  );
